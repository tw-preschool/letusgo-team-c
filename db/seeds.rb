...
items.push :name => '可口可乐', :unit => '瓶', :price => 3.00,:number => 1, :information => '这是好喝的饮料',:promoted => 'false'
items.push :name => '雪碧', :unit => '瓶', :price => 3.00,:number => 1, :information => '这是好喝的饮料',:promoted => 'false'
